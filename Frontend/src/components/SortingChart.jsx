...
function SortingChart() {
  ...
  return (
    <div>
      <div className="mt-4 lg:mx-8 flex flex-col items-center">
        {/* Header */}
                ...
                <div className="space-y-4">
                  <ul className="space-y-4 text-sm text-gray-800 dark:text-gray-300">
                    ...
                    <li className="flex items-start">
                      <span className="w-2 h-2 bg-cyan-500 rounded-full mt-1.5 mr-3 flex-shrink-0"></span>
                      <span className="leading-relaxed">
                        On the other hand, for larger amounts of data, we want
                        to increase the efficiency and speed as far as possible.
                      </span>
                    </li>
                  </ul>
                </div>
